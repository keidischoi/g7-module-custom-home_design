...
class AssetController extends Controller
{
    ...
    public function bootJs(HomeDesignSettingService $service): Response
    {
        try {
            ...
            $cssParts[] = 'html.chd-hide-header-currency .flex.items-center.gap-2 > #header_currency_slot_desktop,'
            ...
            $cssParts[] = '.chd-shop-sort-bar,#chd_shop_sort_bar,'
                ...
                .'display:grid!important;gap:0.5rem!important;grid-auto-flow:row!important;'
                .'grid-auto-columns:unset!important;overflow:visible!important;overflow-x:visible!important;'
                .'grid-template-columns:repeat(3,minmax(0,1fr))!important;}'
                .'@media (min-width:640px){html.chd-shop-quiet-nav #main_content .grid.grid-cols-2,'
                .'html.chd-shop-quiet-nav .chd-shop-product-grid,'
                .'html.chd-shop-quiet-nav .chd-shop-carousel-row,'
                .'.chd-shop-product-grid,.chd-shop-carousel-row{'
                .'grid-template-columns:repeat(6,minmax(0,1fr))!important;}}'
                .'html.chd-shop-quiet-nav .chd-shop-carousel-row > *,.chd-shop-carousel-row > *{'
                .'width:100%!important;min-width:0!important;max-width:none!important;flex:none!important;}'
                .'html.chd-shop-quiet-nav .relative:has(.chd-shop-carousel-row) > button{display:none!important;}'
                .'html.chd-shop-quiet-nav #main_content .aspect-square,.chd-product-card .aspect-square{'
                ...
                .'html.chd-shop-quiet-nav #main_content .aspect-square img,.chd-product-card .aspect-square img{'
                .'width:100%!important;height:100%!important;object-fit:cover!important;}'
                .'html.chd-shop-quiet-nav #main_content .aspect-square .absolute.top-2.left-2,'
                .'.chd-product-card .absolute.top-2.left-2{top:4px!important;left:4px!important;'
                .'right:auto!important;bottom:auto!important;font-size:10px!important;line-height:1.15!important;'
                ...
                .'.chd-product-card .absolute.bottom-2.right-2{bottom:4px!important;right:4px!important;}'
                .'html.chd-shop-quiet-nav #main_content .chd-product-card,.chd-product-card{'
                .'background:transparent!important;background-color:transparent!important;'
                .'border:none!important;border-radius:0!important;box-shadow:none!important;}'
                .'html.chd-shop-quiet-nav #main_content .chd-product-card .p-4,.chd-product-card .p-4{'
                .'padding:0.375rem 0.125rem 0!important;}';
