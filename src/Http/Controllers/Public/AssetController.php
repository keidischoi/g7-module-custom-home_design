    ...
    public function bootJs(HomeDesignSettingService $service): Response
    {
        try {
            ...
            $cssParts[] = '.chd-shop-sort-bar,#chd_shop_sort_bar,'
                ...
                .'html.chd-shop-quiet-nav .chd-shop-product-grid,.chd-shop-product-grid{'
                .'gap:0.5rem!important;grid-template-columns:repeat(3,minmax(0,1fr))!important;}'
                .'@media (min-width:640px){html.chd-shop-quiet-nav #main_content .grid.grid-cols-2,'
                .'html.chd-shop-quiet-nav .chd-shop-product-grid,.chd-shop-product-grid{'
                .'grid-template-columns:repeat(4,minmax(0,1fr))!important;}}'
                .'@media (min-width:1024px){html.chd-shop-quiet-nav #main_content .grid.grid-cols-2,'
                .'html.chd-shop-quiet-nav .chd-shop-product-grid,.chd-shop-product-grid{'
