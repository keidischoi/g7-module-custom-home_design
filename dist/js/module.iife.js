 ...
 * 0.2.53: asset cache-bust; boot must NOT hide the original search form — home-design.js hides it only
...
(function () {
  ...
  try {
    ...
    // 0.2.53: never hide header search form here
  ...
  function injectHomeDesignJs() {
    ...
    var urls = [
      "/api/modules/custom-home_design/assets/home-design.js?v=0.2.53",
      "/api/modules/custom-home_design/assets/home-design?v=0.2.53",
    ];
    var idx = 0;
    function tryNext() {
      if (idx >= urls.length) {
