 ...
 * 0.2.58: asset cache-bust (?v=0.2.58); boot must NOT hide the original search form — home-design.js
...
(function () {
  ...
  try {
    ...
    // 0.2.58: never hide header search form here
  ...
  function injectHomeDesignJs() {
    ...
    var urls = [
      "/api/modules/custom-home_design/assets/home-design.js?v=0.2.58",
      "/api/modules/custom-home_design/assets/home-design?v=0.2.58",
    ];
    var idx = 0;
    function tryNext() {
      if (idx >= urls.length) {
